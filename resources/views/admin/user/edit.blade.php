...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
      <form method="post" action="{{ route('superuser.update', ['superuser' => $data->id]) }}">
      @csrf
      @method('put')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="level" id="level">
                <option value="1" @if($data->level < 2) {{ "selected" }} @endif>User</option>
                <option value="2" @if($data->level > 1) {{ "selected" }} @endif>Admin</option>
            </select>
        </div>
        <div class="mb-3">
            <label for="is_verified" class="form-label">Status Verifikasi</label>
            <select class="form-select" name="is_verified" id="is_verified">
                <option value="1" @if($data->is_verified == 1) {{ "selected" }} @endif>Terverifikasi</option>
                <option value="0" @if($data->is_verified != 1) {{ "selected" }} @endif>Tidak Terverifikasi</option>
            </select>
        </div>
