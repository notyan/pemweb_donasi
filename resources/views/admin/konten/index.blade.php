...
<head>
  ...
  <title>Admin | Manajemen Konten </title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.konten.index') }}" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Edit Konten </p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="/admin/mgrVendor" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manajemen Konten</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title"><a href="{{ route('admin.konten.buat') }}" class="btn btn-dark">Tambah Konten Blog</a></h5>
                  <br/>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  @foreach($list_konten as $konten)
                    <tr>
                      <th>{{ $konten->id }}</li>
                      <td>{{ $konten->judul}}</td>
                      <td><a href="{{ route('admin.konten.edit', ['id' => $konten->id]) }}" class="btn btn-secondary">Edit</a></td>
                      <td>
                      <form action="{{ route('admin.konten.hapus', ['id' => $konten->id]) }}" method="post">
                      @csrf
                      @method('DELETE')
