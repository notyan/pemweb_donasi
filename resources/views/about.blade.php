                        ...
                        <div class="row ">
                            <div class="col-lg-4" >
                             ...
                             <div class="col-lg-4" >
                                <div class="member"  style="height:120px; padding-top:30px;" >
                                  <div class="member-info" style="margin:0px;">
                                    <h4>Muhammad Aufaditya Adinata</h4>
                                    <h5>M0519058</h5>
                                  </div>
                                </div>
                            </div>
