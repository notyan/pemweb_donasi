  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/relawan" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button class="btn btn-dark"><a style="color: white;" href="{{ route('relawan.program.index') }}"><b>< Daftar Programmu</b></a></button>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/relawan">Home</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered">
                        <tr>
                            <td width="250px">Nama Pengirim</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select style="width: 200px" class="form-control" name="status_verifikasi">
                        ...
                        <tr>
                            <td>Status Donasi</td>
                            <td>
                                <select style="width: 200px" class="form-control" name="status_donasi">
                        ...
                        <tr>
                            <td rowspan="3"><button class="btn btn-dark " type="submit" >Konfirmasi</button></td>
                        </tr>
                        </form>
                    </table>
                </div>
