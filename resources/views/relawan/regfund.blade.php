...
<head>
  ...
  <title>Relawan | Daftar Program </title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('relawan.program.list') }}"  class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Berikut Program Yang Tersedia</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <table class="table ">
                        <thead class='thead-dark'>
                            <tr>
                                ...
                                <th>Daftar Sebagai Fundraiser</th>
                            </tr>
                        </thead>
                        <tbody>
